...
public class RSSignatureCaptureViewManager extends ViewGroupManager<RSSignatureCaptureMainView> {
	...
	public static final int COMMAND_GET_POINTS = 3;
	...
	//NOTE: View is RSSignatureCaptureMainView.java, which contains a reference to RSSignatureCapture View
	//which contains the array of points that have been drawn on the canvas!
    ...
    public void saySomething(String message){
        Log.d("ReactNative", "saying something..."+ message);
   }
	...
	public void receiveCommand(
		...
		switch (commandType) {
			...
			case COMMAND_GET_POINTS:{
				 Log.d("ReactNative", "getting points!!");
				return;
			}
