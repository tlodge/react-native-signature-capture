...
public class RSSignatureCaptureView extends View {
	...
	private List<TimedPoint> shapePoints;
	...
	public interface SignatureCallback {
		void onDragged(List<TimedPoint> items);
	}
	...
	public RSSignatureCaptureView(Context context, SignatureCallback callback) {
		...
		shapePoints = new ArrayList<TimedPoint>();
	}
	...
	*/
	...
	private void addPoint(TimedPoint newPoint) {
		//Log.d("ReactNative", "adding timedpoint" + newPoint.x + " " + newPoint.y);
	...
	public void sendDragEventToReact() {
		if (callback != null && dragged) {
			callback.onDragged(shapePoints);
		}
	}
